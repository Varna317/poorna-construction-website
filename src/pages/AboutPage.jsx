          ...
          <div className="row justify-content-center reveal-on-scroll">
            <div className="col-lg-8 col-md-10">
              <div className="poorna-card bg-white text-center p-4 p-md-5">
                ...
                <h2 className="h3 fw-bold text-primary" style={{ marginBottom: '2px' }}>Jeganathan.G</h2>
                <p className="text-danger fw-semibold" style={{ fontSize: '0.95rem', letterSpacing: '0.03em', marginBottom: '8px' }}>
                  Founder
                </p>
                <hr className="mx-auto mb-4" style={{ width: '48px', borderColor: 'var(--color-red)', borderWidth: '2px', opacity: 1, marginTop: 0 }} />
                <p className="text-muted mb-0" style={{ lineHeight: '1.75', maxWidth: '600px', margin: '0 auto' }}>
                  Driven by a vision to build reliable residential and commercial infrastructure along with sustainable energy solutions, Jeganathan.G founded Poorna Energy Construction with a commitment to quality, innovation, and client satisfaction.
                </p>
              </div>
            </div>
          </div>
